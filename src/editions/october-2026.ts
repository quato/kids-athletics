...
export const october2026: Edition = {
  ...
  exhibitionRaces: [
    { age: "Діти з інвалідністю", event: "Біг по прямій 60 м" },
    { age: "2022 – 2023", event: "Біг по прямій 60 м" },
  ...
  adultRace: {
    name: "Steeplechase Mile",
    tagline: "Забіг для батьків, родичів і гостей фесту",
    description:
      "Унікальна можливість для батьків, родичів і гостей фестивалю випробувати себе у справжньому стіпльчезі на милю. Готові прийняти виклик?",
    highlights: [
      "Миля дистанції — 4 кола драйву",
      "2 перешкоди на кожному колі",
      "Окремий залік для дорослих, від 18 років",
    ],
    fee: 500,
    placeLimit: 30,
    minAge: 18,
