...
export const ageCategoryRuns: AgeCategoryRun[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { no: 18, name: "Егор Пенчук", birthYear: 2018, result: "43,03", bib: 318 },
      ...
      { no: 35, name: "Піпа Поліна", birthYear: 2018, result: "30,4", bib: 336 },
      { no: 36, name: "Тарас Сафенков", birthYear: 2018, result: "27,8", bib: 337 },
    ],
  },
  {
    id: "2016-2017",
    ...
    rows: [
      ...
      { no: 2, name: "Баргамон Ірина", birthYear: 2016, result: "31,1", bib: 402 },
      ...
      { no: 16, name: "Єлизавета Казачинська", birthYear: 2017, result: "40,4", bib: 417 },
